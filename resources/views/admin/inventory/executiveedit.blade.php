                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <option value="{{$executive->id}}" {{($exe->executive == $executive->id ? 'selected' : 'disabled') }} >{{$executive->name}}</option>
                        @endforeach
                        </select>
                      </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="short_name" value="{{ $exe->short_name}}" required>
                 ...
                 <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control text-uppercase " name="account"  >
                          <option value="" hidden>Account</option>
                        @foreach($allaccounts as $alls)
                        <option value="{{$alls->id}}" {{($exe->account == $alls->id ? 'selected' : 'disabled') }}>{{$alls->printname}}</option>
                        @endforeach
                        </select>
             ...
             <div class="col-md-3">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " aria-label="Amount (to the nearest dollar)" name="commpercent" value="{{ $exe->commission_percentage }}" >
              ...
              <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input"   name="active" value='1' {{($exe->active == '1' ? 'checked' : '') }}> Active </label>
                            </div>
                          </div>
                          <div class="col-md-3">
           <div class="form-check form-check-info">
            ...
            <div class="form-check form-check-info">
                                ...
                                <label class="form-check-label"><input type="radio" class="form-check-input commission" name="iscomm"   value="1" {{($exe->is_commissioned == '1' ? 'checked' : '') }}> yes </label>
                            </div>
                          </div>
                          <div class="col-md-2">
            ...
            <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input nocommission" name="iscomm"   value="0" {{($exe->is_commissioned == '0' ? 'checked' : '') }}> No </label>
                            </div>
                          </div>
                        </div>
                        <div class="row acccomm" >
                    <div class="col-md-5">
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <option value="{{$all->id}}" {{($exe->comm_pay_account == $all->id ? 'selected' : 'disabled') }}>{{$all->printname}}</option>
                        @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control text-uppercase accname" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="commexp"  >
                          <option value="" hidden>Account</option>
                        @foreach($allaccounts as $alls)
                        <option value="{{$alls->id}}" {{($exe->exe_com_exp_ac == $alls->id ? 'selected' : 'disabled') }}>{{$alls->printname}}</option>
                        @endforeach
                        </select>
                      </div>
                    </div>
