...
@endif
                  <div class="card-body">
                    <h4 class="card-title"></h4>
                     <form class="forms-sample" action ="{{('/createbusinesstype')}}" method = "post" enctype="multipart/form-data">
                   ...
                   <div class="row" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input  class="form-control"  name="btype[]" id="btype" required="required" >
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="companyModalLabel">Business Type Details</h5>
 ...
 <tbody>
    ...
    <tr>
      ...
      <td><a href="/admin/btype-edit/{{$btype->id}}">{{$btype->btype}}</a></td>
      
      <td><a href="/admin/btype-edit/{{$btype->id}}">@if($btype->active==1) Active @else Inactive @endif</a></td>
