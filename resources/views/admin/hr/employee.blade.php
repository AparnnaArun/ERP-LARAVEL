...
@endif
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{('/createemployee')}}" method = "post" enctype="multipart/form-data" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="name" value="{{ old('name') }}" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control datepicker" aria-label="Amount (to the nearest dollar)" name="dob" value="{{ old('dob') }}" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="department" value="{{ old('department') }}">
              ...
              <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="curposition" value="{{ old('curposition') }}">
                      </div>
                    </div>
                </div>
                <div class="col-md-2">
            ...
            <div class="form-check form-check-info">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  class="form-control" aria-label="Amount (to the nearest dollar)" name="bsalary" value="{{old('bsalary')}}" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  class="form-control" aria-label="Amount (to the nearest dollar)" name="allowance" value="{{ old('allowance') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control datepicker" aria-label="Amount (to the nearest dollar)" name="actualdob" value="{{ old('actualdob') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group ">
                        ...
                        <textarea class="form-control" aria-label="Amount (to the nearest dollar)" name="homeaddr" value="{{ old('homeaddr') }}">
                        </textarea>
            ...
            <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " aria-label="Amount (to the nearest dollar)" name="kwttel1" value="{{ old('kwttel1') }}">
            ...
            <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " aria-label="Amount (to the nearest dollar)" name="kwttel2" value="{{ old('kwttel2') }}">
            ...
            <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " aria-label="Amount (to the nearest dollar)" name="hometel" value="{{ old('hometel') }}">
            ...
            <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="email" class="form-control " aria-label="Amount (to the nearest dollar)" name="email" value="{{ old('email') }}">
            ...
            <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " aria-label="Amount (to the nearest dollar)" name="emergency1" value="{{ old('emergency1') }}">
            ...
            <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " aria-label="Amount (to the nearest dollar)" name="emergency1no" value="{{ old('emergency1no') }}">
            ...
            <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " aria-label="Amount (to the nearest dollar)" name="emergency2" value="{{ old('emergency2') }}">
            ...
            <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " aria-label="Amount (to the nearest dollar)" name="emergency2no" value="{{ old('emergency2no') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="spouse" value="{{ old('spouse') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="spouseno" value="{{ old('spouseno') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="nochildren" value="{{ old('nochildren') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="education" value="{{ old('education') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="passportno" value="{{ old('passportno') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control datepicker" aria-label="Amount (to the nearest dollar)" name="weddate" value="{{ old('weddate') }}">
...
<!-- /////////////////////// POPUP FOR FIND BUTTON ////////////////////////  --> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/admin/employee-edit/{{$emp->id}}">{{$emp->empid}}</a></td>
      <td><a href="/admin/employee-edit/{{$emp->id}}">{{$emp->name}}</a></td>
     <td><a href="/admin/employee-edit/{{$emp->id}}">{{$emp->curposition}}</a></td>
