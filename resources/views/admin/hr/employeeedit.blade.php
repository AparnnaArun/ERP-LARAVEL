...
@endif
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{('/editsemployees')}}" method = "post" enctype="multipart/form-data" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="passportno" value="{{ $emmp->passportno  }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control editpicker" aria-label="Amount (to the nearest dollar)" name="weddate" value="{{ $emmp->weddate }}">
