...
@endif
                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control datepicker" placeholder="" aria-label="Username" aria-describedby="basic-addon1"  name="start_date" value="{{ old('start_date') }}">
              ...
              <div class="form-check form-check-info">
                             ...
                             <div class="col-md-2">
                              ...
                              <label class="form-check-label">
                                ...
                                <input type="checkbox" class="form-check-input" name="defaults" value="yes" disabled=""> Default </label>
                                @else
                                 <input type="checkbox" class="form-check-input" name="defaults" value="yes" > Default </label>
                                 @endif
                            </div>
                             </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/admin/financial-year/{{$year->id}}">{{$year->start_date}}</a></td>
      <td><a href="/admin/financial-year/{{$year->id}}">{{$year->end_date}}</a></td>
      <td><a href="/admin/financial-year/{{$year->id}}">{{$year->finyear}}</a></td>
      <td><a href="/admin/financial-year/{{$year->id}}">{{$year->active}}</a></td>
      <td><a href="/admin/financial-year/{{$year->id}}">{{$year->defaults}}</a></td>
    </tr>
   @endforeach
  </tbody>
</table>
