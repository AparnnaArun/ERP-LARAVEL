...
@endif
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{('/createcompany')}}" method = "post" enctype="multipart/form-data" >
            ...
            <div class="row">
              ...
              <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" checked  name="active" value='Active'> Active </label>
                            </div>
            
            <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="trading"   value="trading" > Trading </label>
                            </div>
           
            <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="manufacturing" value="manufacturing" > Manufacturing </label>
                            </div>
                             </div>
                             <div class="col-md-3">
              ...
              <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" checked name="admin"  value="Admin"> Admin </label>
                            </div>
