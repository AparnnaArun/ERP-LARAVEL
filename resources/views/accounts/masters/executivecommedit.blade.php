...
@endif
                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="enrty_no" id="code" value="{{ $co->enrty_no }}"  readonly >
                       
                        <input type="hidden" class="form-control"  name="slno" id="code" value="{{ $co->slno }} "  readonly >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control editpicker"  name="dates" value="{{ \Carbon\Carbon::parse($co->dates)->format('j -F- Y')  }}" required >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          @foreach($exes as $cat)
                          <option value="{{$cat->short_name}}" {{($co->executive == $cat->short_name ? 'selected' : '') }}>{{$cat->short_name}}</option>
                          @endforeach
                        </select>
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"  class="form-control"  name="total_income" value="{{ $co->total_income }}" readonly>
                      <input type="hidden"  class="form-control"  name="comm_pay_account" value="{{ $co->comm_pay_account }}" readonly="">
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control"  name="total_expense" value="{{ $co->total_expense }}" readonly>
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control"  name="profit" value="{{ $co->profit }}" readonly>
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control"  name="commission_payable" value="{{ $co->commission_payable }}" readonly>
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control"  name="commission_paid" value="{{ $co->commission_paid }}" readonly>
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control"  name="balance" value="{{ $co->balance }}" readonly>
  ...
  <option value="1" {{($co->paymentmode == '1' ? 'selected' : '') }}>Cash</option>
 <option value="2"{{($co->paymentmode == '2' ? 'selected' : '') }} >Bank</option>
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control"  name="paycommission" value="{{ $co->paycommission }}" required>
...
<div class="col-md-4">
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text bg-gradient-info text-white required">Bank/Cash</span>
                        </div>
                          <select  class="form-control"  name="bank" value="{{ old('short_name') }}" required >
                          <option value="" hidden>Bank</option>
                          @foreach($account as $cat)
                          <option value="{{$cat->id}}" {{($co->bankcash == $cat->id ? 'selected' : '') }}>{{$cat->printname}}</option>
                          @endforeach
                        </select>
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control"  name="chequeno" value="{{ $co->chequeno }}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control editpickers"  name="chequedate" value="{{ \Carbon\Carbon::parse($co->chequedate)->format('j -F- Y')  }}"  >
