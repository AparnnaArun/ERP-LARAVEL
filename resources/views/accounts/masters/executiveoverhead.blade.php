                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="ovr_no" id="code" value="{{ $voucher->constants }}{{ $nslno }}"  readonly >
               ...
               <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <select  class="form-control "  name="invoice_no" value="{{ old('short_name') }}"  id="catid">
