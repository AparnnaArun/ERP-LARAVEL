                   ...
                   <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="rept_no" id="code" value="{{'Rpt'.$nslno}}"   >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control customer mySelect2 "  name="customer" required >
                ...
                <div class="col-md-4 advnce">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control advances"  name="" value="" readonly >
...
$(function(){
  ...
  $.ajax({ 
         type: "POST",
         url: "{{url('getcinvoice')}}", 
         data: {customer: customer,_token:csrf},
         dataType: "html",  
         success: 
              function(data){
               // alert(data);
