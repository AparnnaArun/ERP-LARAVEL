...
@endif
                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control "  name="advanceno" value=" {{ $adv->advanceno }}" readonly >
                        <input type="hidden" class="form-control "  name="slno" value=" {{ $adv->slno }}" readonly >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control "  name="dates" value=" {{ \Carbon\Carbon::parse($adv->dates)->format('j -F- Y')  }}" required >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control customer "  name="customer" id="" required >
                          ...
                          @foreach($cust as $row)
                        <option value="{{$row->id}}" {{($adv->customer == $row->id ? ' selected' : '') }} >{{$row->name}}</option>
                        @endforeach
  ...
  <option value="1" {{($adv->paymentmode == '1' ? ' selected' : '') }}>Cash</option>
 <option value="2" {{($adv->paymentmode == '2' ? ' selected' : '') }}>Bank</option>
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <option value="{{$cat->id}}" {{($adv->bankcash == $cat->id ? 'selected' : '') }}>{{$cat->printname}}</option>
                          @endforeach
                        </select>
                ...
                <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control"  name="chequeno" value="{{ $adv->chequeno }}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          ...
                          <input type="text"  class="form-control datepickers"  name="chequedate" value="{{ \Carbon\Carbon::parse($adv->chequedate)->format('j -F- Y')  }}"  >
                ...
                <div class="col-md-4 advnce">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="advance" value="{{$adv->advance}}" required >
