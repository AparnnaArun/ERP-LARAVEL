                ...
                <div class="col-md-3">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        @foreach($acc as $ac) 
                         <option value="{{$ac->id}}" >{{$ac->printname}}</option>
                           @endforeach                   
                ...
                <div class="col-md-1">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <button type="button" class="btn btn-gradient-success btn-xs btn-fw gobutton">Go</button>
...
$(".gobutton").click(function(){
  ...
  //alert(startdate);
   $.ajax({ 
         type: "POST",
         url: "{{url('getbandetails')}}", 
         data: {startdate: startdate,_token:csrf,enddate:enddate,account:account},
         dataType: "html",  
         success: 
              function(data){
                alert(data);
