...
@endif
                   ...
                   <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="pymt_no" id="code" value="{{'Pmt'.$nslno}}">
                        <input type="hidden" class="form-control"  name="slno" id="code" value="{{$nslno}}"   >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control vendor mySelect2"  name="vendor" required >
 ...
 <option value="2" >Cheque</option>
  <option value="3" >DD</option>
   ...
   <option value="5" >Adv Settlement</option>
                        </select>
             ...
             <div class="row results">
                    <div class="col-md-4">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="vendor" id="code" value=""   >
              ...
              <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control "  name="erate" value="1"  >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <option value="{{$rows->shortname}}" >{{$rows->shortname}}</option>
                        @endforeach
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text bg-gradient-info text-white ">Project Salary</span>
                        </div>
                        <select class="form-control  "  name="prosal"  >
                        <option value="" hidden >Project Salary</option>
                          @foreach($proo as $ros)
                        <option value="{{$ros->id}}" >{{$ros->entry_no}}</option>
                        @endforeach
           ...
           <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control auto-calc roundoff"  name="roundoff" value="0.000"  >
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control totaladvance"  name="totaladvace" value="" readonly >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control gridtotal"  name="total" value="" readonly >
