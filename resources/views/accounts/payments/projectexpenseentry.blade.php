...
@endif
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{('/createproexps')}}" method = "post" enctype="multipart/form-data" >
           ...
           <div class="row">
            <div class="col-md-4">
                  ...
                  @foreach($execs as $exe)
                        <option value="{{$exe->short_name,old('executive')}}" >{{$exe->short_name}}</option>
                        @endforeach
             ...
             <div class="col-md-2">
              ...
              <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input cash"   name="paymentmode" value='cash'> Cash </label>
                            </div>
                            <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input Cheque"   name="paymentmode" value='cheque'> Cheque </label>
                            </div>
            
            <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input enqpopup credit" name="paymentmode"   value="credit" checked > Credit </label>
                            </div>
            ...
            <div class="form-check form-check-info">
                             ...
                             <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input comm" name="expense_type"   value="3"  > Commission </label>
                            </div>
...
$(".sall,.comm").click(function(){
   token = $("#token").val();
   $("#vennnd").val('').trigger('change');
  $('#vennnd,.Cheque,.cash').prop('disabled', true); 

 
});
$(".Cheque,.cash,.credit").click(function(){
   token = $("#token").val();
  
 radios=$('input[name=paymentmode]:checked').val();
 if(radios=='cheque'){
...
$(".projj").click(function(){
  ...
  $('#vennnd,.Cheque,.cash').prop('disabled', false);
})
