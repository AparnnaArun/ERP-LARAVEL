                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="advanceno" value="{{'Vadv'.$nslno}}" required >
                 ...
                 <div class="col-md-4 ">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"  name="erate" value="{{1}}" required >
...
<!-- /////////////////////// POPUP FOR FIND BUTTON ////////////////////////  --> 
 ...
 @foreach($datas as $data)
    <tr>
      ...
      <td><a href="/accounts/vendor-advance/{{$data->id}}">{{$data->advanceno}}</a></td>
