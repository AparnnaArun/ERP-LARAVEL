...
@endif
                      ...
                      <div class="input-group">
                       ...
                       <select class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="business_type" required="">
                        <option value="" hidden>Business Type</option>
                          ...
                          <option value="{{$btype->id,old('businesstype') }}" {{($vend->business_type == $btype->id ? ' selected' : '') }}>{{$btype->btype}}</option>
                          @endforeach
        ...
        <div class="row mt-1">
            ...
            <button type="button" class="btn btn-gradient-dark btn-rounded btn-fw" disabled="disabled">Cancel</button>
            <button type="button" class="btn btn-gradient-dark btn-rounded btn-fw" data-toggle="modal" data-target=".bd-find-modal-lg" >Find</button>
            <button type="button" class="btn btn-gradient-dark btn-rounded btn-fw" disabled="disabled">Delete</button>
...
<!-- /////////////////////// POPUP FOR FIND BUTTON ////////////////////////  --> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/inventory/vendor-view/{{$vendor->id}}">{{$vendor->vendor}}</a></td>
      <td><a href="/inventory/vendor-view/{{$vendor->id}}">{{$vendor->short_name}}</a></td>
      <td><a href="/inventory/vendor-view/{{$vendor->id}}">{{$vendor->account}}</a></td>
