...
@endif
                  <div class="card-body">
                    <h4 class="card-title"></h4>
                     <form class="forms-sample" action ="{{url('createstores')}}" method = "post" enctype="multipart/form-data">
...
<option value="Workshop" >Workshop</option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input class="form-control"  name="locationname" id="loctype" required="required" value="{{ old('locationname') }}">
                ...
                <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="defaults" value="1" >Default</label>
                            </div>
                          </div>
