...
@endif
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{('/createcrm')}}" method = "post" enctype="multipart/form-data" >
                       ...
                       <input type="hidden" name="id" value="{{ $crm->id }}" id=""/>
                   <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control editpicker" aria-label="Amount (to the nearest dollar)" name="dates" value="{{ \Carbon\Carbon::parse($crm->dates)->format('j -F- Y')  }}" required="required" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                     ...
                     @foreach($exe as $ex)
                        <option value="{{$ex->short_name}}" {{($crm->executive == $ex->short_name ? 'selected' : 'disabled') }} >{{$ex->short_name}}</option>
                        @endforeach
                        </select>
                      </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  class="form-control accname" aria-label="Amount (to the nearest dollar)" name="customer" value="{{ $crm->customer }}">
           ...
           <div class="row">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control "  name="contactperson[]" value="{{$ccrm->contactperson}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control "  name="email[]"  value="{{$ccrm->email}}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text bg-gradient-info text-white"> Contact No</span>
                        </div>
                         <input type="text" class="form-control "  name="contactno[]"  value="{{$ccrm->contactno}}">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control editpicker "  name="followupdate"  value="{{ \Carbon\Carbon::parse($crm->followupdate)->format('j -F- Y')  }}" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <option value="0" 
{{($crm->status == '0' ? 'selected' : '') }}>Open</option>
                   <option value="1" {{($crm->status == '1' ? 'selected' : '') }} >Completed</option>
                   <option value="2" {{($crm->status == '2' ? 'selected' : '') }}>Cancelled</option>
                        </select>
                      </div>
                    </div>
                </div>
