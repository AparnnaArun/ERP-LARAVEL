...
@endif
                  <div class="card-body">
                   ...
                   <div class="row">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="req_no" value="{{ $reequsi->po_no }}"  readonly >
            ...
            <div class="row">
              ...
              <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input"   name="urgency_level" value='Low' {{($reequsi->urgency_level == 'Low' ? 'checked' : 'disabled') }} > Low </label>
                            </div>
           ...
           <div class="form-check form-check-info">
              ...
              <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input"   name="request_from" value='Direct' {{($reequsi->request_from == 'Direct' ? 'checked' : 'disabled') }}> Direct </label>
                            </div>
                 ...
                 <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text bg-gradient-dark text-white  ">@if($reequsi->is_grned =='1') Full Goods Received @elseif($reequsi->is_grned =='2') Partial Goods Received @else Pending GRN @endif</span>
                        </div>
      ...
      <td><input type="hidden" class="form-control "  name="id1[]" value="{{$item->id}}" >
        <input type="hidden" class="form-control "  name="item_code[]" value="{{$item->code}}" >
        {{$item->item_code}}</td>
      <td>{{$item->item_name}}</td>
     
      <td>{{$item->unit}}</td>
      <td>
        <input type="hidden" class="form-control auto-calc reqqnty"  name="papprqnty[]" value="{{$item->apprqnty}}"   placeholder="Approved Qnty">{{$item->apprqnty}}</td>
       <td>
        {{$item->grnqnty}}</td>
       <td>
        {{$item->rate}}</td>
