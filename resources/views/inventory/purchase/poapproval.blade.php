                  ...
                  <div class="card-body">
                   ...
                   <div class="row">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="po_no" id="code" value=""  readonly >
              ...
              <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="reference" value="{{old('reference')}}" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="project_code"  >
           ...
           <div class="form-check form-check-info">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                     ...
                     @foreach($curr as $cur)
                        <option value="{{$cur->id,old('currency')}}" >{{$cur->shortname}}</option>
                        @endforeach
                        </select>
                      </div>
                    </div>
              ...
              <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="fob_point" value="{{old('fob_point')}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="order_validity" value="{{old('order_validity')}}" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control datepicker" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="deli_date" value="{{old('deli_date')}}" >
  ...
  <button type="button" class="close" data-dismiss="alert">×</button></div>
                ...
                <div class="col-md-4 col-md-offset-0">
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control tqnty" placeholder="" name="tot_qnty" value="{{old('tot_qnty')}}" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control tamount " placeholder="" name="tamount" value="{{old('tamount')}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal disctotal" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="discount_total"  value="{{0}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal erate " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="erate"  value="{{1}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal gridtotal " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="total"  value="{{old('total'),0}}" readonly>
                          <input type="hidden" class="form-control auto-cal totalcost " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="totcosts"  value="{{old('total'),0}}" readonly> 
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal tax" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="tax"  value="{{0}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal freight" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="freight"  value="{{0}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal pf " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="pf"  value="{{0}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal insurance" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="insurance"  value="{{0}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal others" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="others"  value="{{0}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal  nettotal" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="net_total"  value="{{old('net_total'),0}}" readonly>
        ...
        <div class="row mt-1">
            ...
            <button type="button" class="btn btn-gradient-dark btn-rounded btn-fw" >Delete</button>
             @if (session('status'))
             <a href="{{url('printpoapproval')}}" type="button" class="btn btn-gradient-dark btn-rounded btn-fw" >Print</a>
             @endif
          </div>
        </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="companyModalLabel">Pending Purchase Order Details</h5>
  ...
  <tbody>
   @foreach($po as $data1)
    <tr>
      ...
      <td><a href="/inventory/po-approval/{{$data1->id}}">{{$data1->po_no}}</a></td>
     
      <td><a href="/inventory/po-approval/{{$data1->id}}">{{$data1->odr_by}}</a></td>
    
    
    <td><a href="/inventory/po-approval/{{$data1->id}}">@if($data1->is_approved=='0') Pending @elseif($data1->is_approved=='2') Partially Approved @endif </a></td>
