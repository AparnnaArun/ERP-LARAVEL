           ...
           <div class="form-check form-check-info">
                ...
                <div class="table table-responsive">
                    <table class="table table-striped ItemGrid" id="ItemGrid">
                      ...
                      <tbody>
                      <tr>
                        @foreach($reequsi->requestforquotationdetail as $item)
      <th scope="row">{{$loop->iteration}}</th>
     <td><input type="hidden" class="form-control "  name="item_code[]" value="{{$item->item_code}}" id="code"  placeholder="Current Stock">
        {{$item->item_code}}</td>
      <td><input type="hidden" class="form-control gridid"  name="" value="{{$item->id}}" id="item_id"  placeholder="Current Stock">
        <input type="hidden" class="form-control gridid"  name="item_id[]" value="{{$item->item_id}}" id="item_id"  placeholder="Current Stock">
