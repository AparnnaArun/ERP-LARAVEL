          ...
          <div class="col-md-7">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input  class="form-control auto-calc pcost"  name="purchasecost"  readonly value="{{$pi->totalamount}}" >
              ...
              @foreach($pcost->purchasecostdetail as $data)
                ...
                <div class="table table-responsive">
                    <table class="table table-striped CostTable" id="CostTable">
                      ...
                      <tbody>
                        @foreach($charge->costcalculationdetail as $items)
                    <tr>
      <th>{{$loop->iteration}}</th>
      <td><input type="hidden" class=""  name="code[]" 
