...
@endif
                  <div class="card-body">
                   ...
                   <div class="row">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control"   name="req_no" id="code" value="{{ $voucher->constants }}{{ $nslno }}"  readonly >
              ...
              <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control "   name="reqdept" value="{{old('reqdept')}}" >
  ...
  <tbody>
   ...
   <!--  
    <td><a href="/inventory/reqisition/{{$data->id}}">Deleted</a></td> -->
