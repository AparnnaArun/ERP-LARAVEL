                  ...
                  <div class="card-body">
                   ...
                   <div class="row">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="transfer_no" id="code" value="{{ $tran->transfer_no }}"  readonly >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control editpicker" aria-label="Amount (to the nearest dollar)" name="transfer_date" value="{{ \Carbon\Carbon::parse($tran->transfer_date)->format('j -F- Y')  }}
" required="required" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="transfer_to" required="" >
                          <option value="" hidden>Location</option>
                     @foreach($store as $cust)
                        <option value="{{$cust->id,old('transfer_to')}}" {{($tran->transfer_to == $cust->id ? 'selected' : 'disabled') }} >{{$cust->locationname}}</option>
                        @endforeach
                        </select>
                      </div>
                    </div>
  ...
  <button type="button" class="close" data-dismiss="alert">×</button></div>
                ...
                <div class="table table-responsive">
                    <table class="table table-striped ItemGrid" id="ItemGrid">
                      ...
                      <tbody>
                        @foreach($tran->stocktransferdetail as $item)
                        <tr>
    ...
    @endforeach 
                ...
                <div class="col-md-4">
                  <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control totalcost" aria-label="Amount (to the nearest dollar)" name="total_amount" value="{{ $tran->total_amount }}" required="required"  readonly="">
        ...
        <div class="row mt-1">
            ...
            <button type="button" class="btn btn-gradient-dark btn-rounded btn-fw" disabled >Delete</button>
