                  ...
                  <div class="card-body">
                   ...
                   <div class="row">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="rtn_no" id="code" value="{{ $rtns->rtn_no }}"  readonly >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control datepicker" aria-label="Amount (to the nearest dollar)" name="rtndate" value="{{ \Carbon\Carbon::parse($rtns->rtndate)->format('j -F- Y')  }}" required="required" >
                ...
                <div class="col-md-4" id="podiv">
                    <div class="form-group">
                     ...
                     @foreach($store as $sto)
                        <option value="{{$sto->id,old('location')}}" {{($rtns->location == $sto->id ? 'selected' : 'disabled') }}>{{$sto->locationname}}</option>
                        @endforeach
                        </select>
           ...
           <div class="row">
              <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="customer_id" required="" id="customer">
                          <option value="" hidden>Customer</option>
                     @foreach($customer as $cust)
                        <option value="{{$cust->id,old('customer_id')}}" {{($rtns->customer_id == $cust->id ? 'selected' : 'disabled') }} >{{$cust->short_name}}</option>
                        @endforeach
                        </select>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input type="text" class="form-control invoiceno" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="salesid"  value="{{$datas1->invoice_no}}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                     ...
                     @foreach($currency as $cur)
                        <option value="{{$cur->shortname,old('currency')}}" {{($rtns->currency == $cur->shortname ? 'selected' : 'disabled') }}>{{$cur->shortname}}</option>
                        @endforeach
                        </select>
                      </div>
                    </div>
              ...
              <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="executive"  value="{{$rtns->executive}}" readonly>
                      </div>
                    </div>
                </div>
                    <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="salesdate"  value="{{ \Carbon\Carbon::parse($rtns->salesdate)->format('j -F- Y')  }}" readonly>
              ...
              <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input"   name="payment_mode" value='cash'{{($rtns->payment_mode == 'cash' ? 'checked' : 'disabled') }}> Cash </label>
                            </div>
            
            <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input " name=""    value="credit" {{($rtns->payment_mode == 'credit' ? 'checked' : 'disabled') }} > Credit </label>
                            </div>
                ...
                <div class="table table-responsive">
                    <table class="table table-striped ItemGrid" id="ItemGrid">
                      ...
                      <tbody>
                        @foreach($rtns->salesreturndetail as $item)
<tr>
   ...
   <td>{{$item->discount}}</td>
    ...
    @endforeach
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal disctotal" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="discount_total"  value="{{$rtns->discount_total}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal erate " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="erate"  value="{{$rtns->erate}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal gridtotal " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="total"  value="{{$rtns->total}}" readonly>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal tax" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="tax"  value="{{$rtns->tax}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal freight" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="freight"  value="{{$rtns->freight}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal pf " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="pf"  value="{{$rtns->pf}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal insurance" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="insurance"  value="{{$rtns->insurance}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal others" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="others"  value="{{$rtns->others}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-cal  nettotal" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="net_total"  value="{{$rtns->net_total}}" readonly>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <textarea class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="vehicle_details" >
                         {{$rtns->vehicle_details}}
        ...
        <div class="row mt-1">
           ...
           <a href="{{url('printereturn')}}/{{$rtns->id}}" type="button" class="btn btn-gradient-dark btn-rounded btn-fw" >Print</a>
