...
<input type="hidden" class="form-control  inputpadd"  name="rsrates"  id="rsrates"   value="{{$rsrate}}">
...
<input type="hidden" class="form-control   inputpadd idid"   name="itids[]"   id=""   required="required" value="{{$cur->item_id}}">
<input type="hidden" class="form-control"   name="itcode[]"   id=""   required="required" value="{{$cur->code}}">
<input type="hidden" class="form-control"   name="itname[]"   id=""   required="required" value="{{$cur->item}}">
<input type="hidden" class="form-control"   name="itunit[]"   id=""   required="required" value="{{$cur->unit}}">
  ...
  <td><input type="hidden" class="form-control calculate  inputpadd"  name="doqty[]" value="{{$cur->quantity}}"    >
    ...
    <input type="hidden" class="form-control calculate bqnty inputpadd"  name="dobty[]" value="{{$cur->inv_qnty}}" id="balqnty"   >
    <input type="hidden" class="form-control calculate bqnty inputpadd"  name="itrate[]" value="{{$cur->rate}}"    >{{$cur->inv_qnty}}</td>
...
$('tbody', '.stocktable').append( clonedRowFromTable1 )
    ...
    $(`.rtnqnty[data-id= ${itemid}]`).val(totqnty);
