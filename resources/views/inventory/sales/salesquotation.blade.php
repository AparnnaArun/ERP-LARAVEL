...
@endif
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action ="{{('/createsalesquote')}}" method = "post" enctype="multipart/form-data" >
                   ...
                   <div class="row">
                      ...
                      <div class="input-group">
                       ...
                       @if(!empty($voucher->constants))
                        <input type="text" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="qtn_no" id="code" value="{{ $voucher->constants }}{{ $nslno }}"  readonly >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  class="form-control accname" aria-label="Amount (to the nearest dollar)" name="qtn_ref" value="{{ old('qtn_ref') }}">
              ...
              <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control mySelect2" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="customer" required="" id="customer">
  ...
  {{ session('failed') }}
                    ...
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="authority" value="{{old('authority')}}" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       <input  class="form-control " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="validity" value="{{old('validity')}}" >
              ...
              <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" checked  name="from_enquiry" value='0'> Direct </label>
                            </div>
            
            <div class="form-check form-check-info">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input enqpopup" name="from_enquiry"   value="1"  > Enquiry </label>
                            </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <select class="form-control itemvalue  mySelect2" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="" id="item" >
...
<div class="col-md-11 salesenq" >
  ...
  <button type="button" class="close" data-dismiss="alert">×</button></div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-calc disctotal" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="discount_total"  value="{{0}}" >
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-calc gridtotal " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="total"  value="{{old('total'),0}}" readonly>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                         ...
                         <input type="text" class="form-control auto-calc nettotal " placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="net_total"  value="{{0}}" readonly>
        ...
        <div class="row mt-1">
            ...
            @if (session('status'))
            <a href="{{url('printsalesquote')}}" type="button" class="btn btn-gradient-dark btn-rounded btn-fw" >Print</a>
            @endif
          </div>
        </div>
