...
const d = new Date();
var cmonth =monthNames[d.getMonth()];
var prmonth =monthNames[d.getMonth()-1];
var prrmonth =monthNames[d.getMonth()-2];
var sinv1 =$("#sinv1").val();
var sinv2 =$("#sinv2").val();
var sinv3 =$("#sinv3").val();
//alert(sinv2);
  'use strict';
  var data = {
    labels: [cmonth,prmonth,prrmonth],
    datasets: [{
      label: '# Sales ',
      data: [10, 19, 3, 5, 2, 3],
      backgroundColor: [
  ...
  var areaData = {
    labels: [cmonth,prmonth,prrmonth],
    datasets: [{
      label: 'sales amount in KWD',
      data: [sinv1, sinv2, sinv3],
      backgroundColor: [
        'rgba(205, 199, 522, 0.2)',
        'rgba(54, 162, 235, 0.2)',
        'rgba(255, 206, 86, 0.2)'
      ],
      borderColor: [
