...
class CreatePurchaseorderapprovaldetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchaseorderapprovaldetails', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purchaseorderapprovaldetails');
    }
}
